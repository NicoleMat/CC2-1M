...
public static void main(String args[]) throws IOException, java.io.IOException  
{
    ...
    System.out.println("Welcome to MorseCode to English Translator");
    System.out.println("");
    do
    {
    System.out.println("Enter the Option Corresponding to the Task you want to Perform ");
    System.out.println("1.English to Morse Code <- OR ->2.Morse Code to English<- OR ->3.Exit ");
    System.out.print(">");
    while(!sc.hasNextInt()) 
    {
        System.out.println("");
